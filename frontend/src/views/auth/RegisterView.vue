      ...
      <div class="brand-panel">
        ...
        <div class="brand-content">
          ...
          <div class="brand-hero">
            <h2 class="hero-title">
              <span class="hero-line">开启你的</span>
              <span class="hero-line hero-accent">智能旅行</span>
            </h2>
            <p class="hero-desc">创建账号，体验 AI 驱动的个性化行程规划服务</p>
          </div>
          ...
          <div class="register-steps">
            <div class="step-item">
              ...
              <div class="step-info">
                ...
                <span class="step-desc">输入手机号和密码</span>
              </div>
            </div>
            ...
            <div class="step-item">
              ...
              <div class="step-info">
                ...
                <span class="step-desc">短信验证码确认</span>
              </div>
            </div>
            <div class="step-connector"></div>
            <div class="step-item">
              ...
              <div class="step-info">
                <span class="step-title">开始探索</span>
                <span class="step-desc">生成你的第一份行程</span>
              </div>
            </div>
          </div>
          ...
          <div class="brand-quote">
            ...
            <div class="quote-author">
              ...
              <div>
                <span class="author-name">旅行者小王</span>
                <span class="author-role">智游年度会员</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="form-panel">
        <div class="form-container">
          <div class="form-header">
            ...
            <p class="form-subtitle">注册智游，开启智能旅行体验</p>
          </div>
          ...
          <div v-if="activeTab === 'wechat'" class="auth-form">
            ...
            <div class="divider">
              ...
              <span class="divider-text">或使用授权码注册</span>
              <span class="divider-line"></span>
            </div>
...
async function handlePasswordRegister() {
  ...
  if (!form.value.smsCode) { errorMsg.value = '请先获取并输入短信验证码'; return }
  if (form.value.smsCode.length !== 6) { errorMsg.value = '请输入6位验证码'; return }
  ...
  try {
    const result = await register(form.value.phone, form.value.password, form.value.smsCode, form.value.nickname)
...
async function handleWechatRegister() {
  ...
  try {
    await loginByWechat(form.value.wechatCode, form.value.nickname)
    router.replace({ path: '/login', query: { registered: '微信用户' } })
  } catch (err: any) {
    if (err?.code === 'ECONNABORTED' || err?.code === 'ERR_NETWORK') {
      errorMsg.value = '网络连接失败，请确认后端服务已启动'
    } else {
      errorMsg.value = err?.response?.data?.detail || '微信注册失败，请重试'
    }
  }
}
...
function showTerms() {
  ElMessageBox.alert(
    '欢迎使用智游！使用本服务即表示您同意我们的服务条款和隐私政策。我们重视您的隐私并致力于保护您的个人信息。',
    '用户协议',
...
// ============================================
// Design Tokens (same as LoginView)
// ============================================
$bg-deep: #0a0e1a;
$bg-card: #111827;
$bg-input: #1a2235;
...
.qr-icon { width: 48px; height: 48px; }
